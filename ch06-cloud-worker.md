...
我自己建了三套 multi-agent production 系統（Hera、Athena、Gaia），第八章會用 Gaia 做完整的深入拆解。這裡只要知道：它們的核心不是 Agent Teams 這個實驗功能，而是 Subagents + Background Agent + 明確的 CLAUDE.md 邊界定義。
...
第七章我們把前面所有工具串在一起，看看一個完整的日常工作流長什麼樣。
